...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        raw_datasets["validation"] = raw_datasets["train"].train_test_split(test_size=0.2, seed=42)["test"]
    ...
    n_train_steps = training_args.num_train_epochs*len(train_dataset)//training_args.per_device_train_batch_size
    print("calculated num train steps for scheduler: ", n_train_steps)
    optimizer = AdamW(model.parameters(), lr=training_args.learning_rate)
    scheduler = get_cosine_schedule_with_warmup(optimizer, num_warmup_steps=training_args.warmup_steps,
